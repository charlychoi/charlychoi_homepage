...
export const metadata: Metadata = {
  ...
  openGraph: { title: "현장 업무에 바로 적용하는 AI 활용 교육과 AX 컨설팅", description: "찰리초이 | AI 활용 강사·컨설턴트·작가", type: "website", locale: "ko_KR", url: "/", siteName: "찰리초이", images: [{ url: "/charlychoi-left.png", width: 1024, height: 1024, alt: "AI 활용 강사 찰리초이" }] },
  twitter: { card: "summary_large_image", title: "현장 업무에 바로 적용하는 AI 활용 교육과 AX 컨설팅", description: "찰리초이 | AI 활용 강사·컨설턴트·작가", images: ["/charlychoi-left.png"] },
};
